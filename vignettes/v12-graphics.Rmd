...
```r
if (requireNamespace("plotly", quietly = TRUE)) agri_interactive(fit, "data")
if (requireNamespace("plotly", quietly = TRUE)) agri_interactive(fit, "effects")
if (requireNamespace("plotly", quietly = TRUE)) agri_interactive(df, "interaction")
```
