...
#> <environment: 0x0000018cc65966d0>
```
...
#>  Time level:   20 35 50 65 
#>  Group level:   C1 C2 C3 
#>  If the order is not correct, specify the correct order in time.order or group.order.
fit_r$omnibus
#>    Statistic       df      p-value        effect
#> 1  4.5870835 1.985998 1.034804e-02      cultivar
#> 2 49.9673216 2.734477 1.140384e-29          time
#> 3  0.4323595 5.187657 8.328565e-01 cultivar:time
```
...
#> 1 60 1.084035 0.8833927 0.8806807 -6.661338e-15 0.8214748
```
